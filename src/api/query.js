...
import { authoritySignUp, confirmResolution, fetchConflictIssues, fetchForwardedissues, fetchIssueByAuthority, fetchIssueById, fetchIssuesByOffice, fetchNearByIssues, forwardIssue, getAnalytics, getUser, rejectResolution, sendIssue, unUpVote, updateIssue, upVote, userSignUp } from "./index";
...
export const useFetchNearByIssues = (latitude, longitude,search) => {
    ...
    const updateUpVote = (issueId,type) => {
        ...
        queryClient.setQueryData(
            ["nearByIssues", latitude,longitude, search],
            (oldData) => {
