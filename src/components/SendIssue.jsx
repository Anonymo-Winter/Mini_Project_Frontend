...
const ChatMessage = ({ content, isUser }) => (
    <div
        className={`flex ${isUser ? "justify-end" : "justify-start"} mb-4 animate-in slide-in-from-${
            isUser ? "right" : "left"
        }`}
    >
        <div
...
const IssueForm = () => {
    ...
    const dummyMessages = [
        ...
        {
            content:
                "Here's a suggested description: 'The street light at [location] has been non-functional for [time period], creating a safety hazard during nighttime hours. The area is frequently used by pedestrians and vehicles.'",
            isUser: false,
        },
    ];
                ...
                <Card className="max-w-[1200px] w-11/12 mx-auto shadow-lg transition-shadow duration-200 hover:shadow-xl">
                    ...
                    <CardContent className="p-6">
                        <div className="flex gap-3 h-full md:flex-row flex-col">
                            ...
                            <div className="space-y-2 w-full md:w-1/2" style={{ zIndex: 0 }}>
                                {" "}
                                {/* Add lower z-index to map container */}
                                ...
                                <p className="text-sm text-gray-500 mt-2">
                                    Selected coordinates: {markerPosition?.lat?.toFixed(4)},{" "}
