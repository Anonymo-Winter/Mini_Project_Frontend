...
const Issue = () => {
  ...
  const {data,status,isFetchingNextPage,isError,hasNextPage,fetchNextPage,isLoading,updateUpVote} = useFetchNearByIssues(userData?.latitude,userData?.longitude,actualSearch)
  ...
  if(isError) return <div className='h-screen flex items-center justify-center'><AlertCircle className="h-10 w-10 animate-spin mx-auto" /></div>
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-[1400px] mx-auto p-4 lg:p-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => navigate('/send-issue')} className="bg-blue-600 hover:bg-blue-700 text-white px-4 text-sm rounded-md">
                Report Issue
              </button>
            </div>
          </div>
        ...
        {/* Main Content */}
        {isLoading ?<div className="min-h-[60vh] flex items-center justify-center">
           
           <Loader />
         
     </div> : data.pages[0].data.issues.length === 0 ? (
        ...
        <TabsList className="bg-white/80">
          ...
          <TabsTrigger value="map" onClick={() => setView('map')}>Map View</TabsTrigger>
          <TabsTrigger value="split" onClick={() => setView('split')}>Split View</TabsTrigger>
        </TabsList>
